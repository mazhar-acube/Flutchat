...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  void _openVideoCallScreen() async {
    ...
    try {
      callDuration = await platform.invokeMethod("openZoomChat");
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        // )
        _callDuration != null? Text("Last call duration : $_callDuration"):Container(),
      ],
    );
  }
}
...
class InfoTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Center(
        child: Text(
          "This is Sample Flutter App that uses Android Native Zoom SDK for Video calls.",
